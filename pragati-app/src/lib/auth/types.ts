...
export const DEMO_CREDENTIALS: Record<UserRole, { email: string; password: string; user: DemoUser }> = {
  ...
  provider: {
    ...
    user: {
      ...
      facilityName: "Nandurbar District Civil Hospital",
      facilityId: "fac-001",
      department: "Central Pharmacy & Facility Supplies",
      providerRole: "Chief Pharmacist & Supply Chain Lead",
    },
  },
  government: {
    ...
    user: {
      ...
      email: "government@pragati.demo",
      role: "government",
      govDepartment: "Department of Public Health, Government of Maharashtra",
      districtAccess: ["All 36 Districts"],
    },
  },
};
