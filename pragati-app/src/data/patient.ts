  ...
  currentMedications: [
    {
      ...
      duration: "30 days",
      prescribedBy: "Dr. Ananya Natarajan, MD, DM (Cardiology)",
...
export const DEMO_HEALTH_RECORDS: HealthRecord[] = [
  {
    ...
    doctor: "Dr. Ananya Natarajan, MD, DM (Cardiology) · TMC-2014-08-3921",
    facility: "Government General Hospital, Chennai",
  ...
  },
  {
    ...
    doctor: "Dr. Ananya Natarajan, MD, DM · Dr. P. Rajasekar (Cardiologist)",
    facility: "Government General Hospital, Chennai · Diagnostic Wing",
  ...
  },
  {
    ...
    doctor: "Dr. M. Senthil Nathan, MD (Biochemistry)",
    facility: "Government General Hospital, Chennai · Central Clinical Pathology Lab",
  ...
  },
  {
    ...
    doctor: "Dr. S. Meenakshi, MD (Radiodiagnosis)",
    facility: "Government Stanley Medical College Hospital · Radiology Unit",
  ...
  },
  {
    ...
    doctor: "Dr. Ananya Natarajan, MD, DM (Cardiology) · TMC-2014-08-3921",
    facility: "Government General Hospital, Chennai · Cath Lab & Daycare",
    hospitalDept: "Cardiac Catheterization Laboratory",
    date: "2026-08-30",
    displayDate: "30 Aug 2026",
    summary: "AI-assisted informed consent recorded via PRAGATI Care (Session ID: PRG-AIC-7829). Patient comprehension verified at 100% on procedural steps, expected risks (3-5% minor hematoma), and alternatives. Clinician review digitally signed by Dr. Ananya Natarajan.",
  ...
  },
  {
    ...
    doctor: "Dr. S. Karthikeyan, MD · Dr. R. Lakshmi, MBBS",
    facility: "Government Urban Primary Health Centre (UPHC), Triplicane",
...
export const DEMO_REFERRAL = {
  id: "REF-TN-2026-0041",
  fromFacility: "Government Urban Primary Health Centre (UPHC), Triplicane",
  toFacility: "Government General Hospital, Chennai",
  referringFacility: "Government Urban Primary Health Centre (UPHC), Triplicane",
  referringDoctor: "Dr. R. Lakshmi, MBBS",
  receivingFacility: "Government General Hospital, Chennai",
  receivingDoctor: "Dr. Ananya Natarajan, MD, DM (Cardiology)",
  specialty: "Cardiology",
